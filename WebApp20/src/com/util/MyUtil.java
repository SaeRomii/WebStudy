...
public class MyUtil
{
	...
	public String pageIndexList(int currentPage, int totalPage, String listUrl)
	{
		...
		int numPerBlock = 10;
		//-- 페이지 처리 시 게시물 리스트 하단의 숫자를 10개씩 보여주겠다.
		
		int currentPageSetup;
		//-- 현재 페이지 설정값(이 페이지를 기준으로 보여주는 숫자가 달라져야 하기때문에)
		
		int page;
		int n;
		//-- 이전 페이지 블럭과 같은 처리에서 이동하기 위한 변수(얼마만큼 이동해야 하는지)
		//(13페이지에서 23페이지로 넘어가게 하는 변수)
		...
		*/
		...
		//	 searchKey 값과 serachValue 값이 들어있는 상황이므로
		//	 『&』를 붙여서 추가해 주어야 한다.
		// 값 넘길 때 name=홍길동&pageNum=4 이렇게 넘겨야해서 & << 요거
		...
		//   20이 되는데
		//   이런 상황이라면 다시 10을 빼서 10으로 만들어 주어야 한다.
		...
		//   2 페이지가 되고, 22에서 『Prev』할 경우 12 페이지가 될 수 있도록 처리하는 방식이다.
