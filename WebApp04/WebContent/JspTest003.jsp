...
<!-- 
	※ 요청한 페이지의 결과를 확인한 후 새로고침(F5)을 반복해보면
	   ...
	   - 경로
	     C:\WebStudy_run\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\work\Catalina\localhost\WebApp04\org\apache\jsp
	     -----------																				 --------
	     workspace																					 project
