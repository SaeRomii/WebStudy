...
<%
	...
	*/
	...
	result = jsonObject.toString();	      //문자열 구성 result에 담아
	...
	※ 핵심 기본 라이브러리(json-lib-x.x-jdkxx.jar)
	1. 『http://www.json.org』 요청 및 접근
	2. 페이지 하단의 『Java』 카테고리의 『Json-lib』 클릭
	   → 『http://json-lib.sourceforge.net/』으로 이동
	3. 페이지 왼편의 Download 클릭
	   → 『http://sourceforge.net/projects/json-lib/files/』로 이동
	4. 페이지 리스트 중 『json-lib』클릭
	   → 『http://sourceforge.net/projects/json-lib/files/json-lib/』로 이동
	5. 페이지 리스트 중 『json-lib-2.4』 클릭
	   → 『http://sourceforge.net/projects/json-lib/files/json-lib/json-lib-2.4/』로 이동
