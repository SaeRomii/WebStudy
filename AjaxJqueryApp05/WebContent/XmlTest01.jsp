		...
		$("#sendBtn").click(function()
		{
			...
			$.ajax(
			{
				...
				, success : function(args)
				{
					...
					{
						var item = $(this);
						var num = item.attr("num");		// arrtriute 속성
					...
					$("#resultDiv").html(out);		// 내용을 resultDiv 에 삽입
					
					$("#name").val("");				// name 비우기
					$("#content").val("");			// content 비우기
					$("#name").focus();				// 이름에 포커스
				...
				, error : function(e)
				{
					alert(e.responseText);		// 클라이언트쪽에서 보는거
					console.log(e);				// 서버쪽에서 보는거
				}
			});
		});
	});
